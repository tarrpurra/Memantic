...
const NAV_LINKS = [
  { label: "Pre Meme Marketplace", href: "/pre-marketplace", icon: Store, type: "route" },
  { label: "Meme NFT Marketplace", href: "/marketplace", icon: ShoppingBag, type: "route" },
      ...
      <header className="sticky top-0 z-40 border-b border-border/40 bg-background/70 backdrop-blur-xl">
        ...
        {menuOpen && (
          <div className="lg:hidden border-t border-border/50 bg-background/95 backdrop-blur-xl">
            <div className="mx-auto flex max-w-6xl flex-col gap-1 px-5 py-4 sm:px-8" aria-label="Mobile Navigation">
              {navLinks.map((link) => {
                const Icon = link.icon;
                const isActive = activeLink === link.href;
                return (
